        ...
        <div className="auth-card text-center">
          ...
          {emailSent ? (
            <>
              ...
              <Link
                href="/login"
                className="inline-block bg-primary text-primary-foreground px-6 py-2.5 rounded-xl font-semibold text-sm mb-4 hover:bg-primary/90 transition-colors"
              >
            ...
            <>
              ...
              <Link
                href="/login"
                className="inline-block bg-primary text-primary-foreground px-6 py-2.5 rounded-xl font-semibold text-sm mb-3 hover:bg-primary/90 transition-colors"
              >
                Sign in
              </Link>
