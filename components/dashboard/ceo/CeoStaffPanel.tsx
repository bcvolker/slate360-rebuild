      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-lg bg-[#1E3A8A] px-3 py-2 text-xs font-bold text-white hover:bg-[#1E3A8A]/90 transition-colors"
          >
            <UserPlus size={13} />
            Grant Access
          </button>
      ...
      {loading ? (
        ...
        <div className="space-y-2">
          {activeStaff.map((member) => (
            ...
            >
              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[#1E3A8A]/10 text-[#1E3A8A] text-xs font-black shrink-0">
