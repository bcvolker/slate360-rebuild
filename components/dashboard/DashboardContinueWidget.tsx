      ...
      <div className="space-y-2">
        {items.map((item, index) => {
          ...
          return (
            ...
            >
              <div className="w-9 h-9 rounded-xl bg-gray-100 flex items-center justify-center text-gray-500 group-hover:text-[#D4AF37] transition-colors">
                <Icon size={16} />
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-xs font-semibold text-gray-900 truncate group-hover:text-[#D4AF37] transition-colors">{item.title}</p>
