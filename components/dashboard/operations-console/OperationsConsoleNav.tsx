...
const sections: { label: string; href: string; icon: LucideIcon; detail: string }[] = [
  { label: "Access Queue", href: "/operations-console", icon: Users2, detail: "Approve Version 1 accounts and revoke access." },
  { label: "Feedback Inbox", href: "/operations-console/feedback", icon: Inbox, detail: "Bugs, feature requests, screenshots, and user replies." },
  ...
  { label: "Product Health", href: "/operations-console/product-health", icon: BarChart3, detail: "Module usage, dead links, errors, and release readiness." },
...
export function OperationsConsoleNav({ active }: { active: string }) {
  return (
