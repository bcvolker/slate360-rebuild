    ...
    <header className="fixed top-0 inset-x-0 z-50 border-b border-header bg-header-glass text-header">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
        ...
        <div className="hidden md:flex items-center gap-3">
          <Link
            href="/login"
            className="px-4 py-2 rounded-lg text-sm font-medium text-header/70 hover:text-teal hover:bg-teal-soft transition-colors"
          >
            Sign in
          </Link>
          <Link
        ...
        {/* ── Hamburger button ─────────────────────────── */}
        <button
          className="md:hidden p-2 rounded-lg text-header/70 hover:bg-primary/10 transition-colors"
