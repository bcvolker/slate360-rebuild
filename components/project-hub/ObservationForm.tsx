    ...
    <div className="fixed inset-y-0 right-0 z-50 w-full max-w-md bg-white shadow-2xl border-l border-gray-200 flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm text-gray-900 placeholder:text-gray-400 focus:border-[#F59E0B] focus:outline-none focus:ring-1 focus:ring-[#F59E0B]/30"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm text-gray-900 placeholder:text-gray-400 focus:border-[#F59E0B] focus:outline-none focus:ring-1 focus:ring-[#F59E0B]/30 resize-none"
          />
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <select
              ...
              className="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm text-gray-900 focus:border-[#F59E0B] focus:outline-none"
            >
      ...
      <div className="border-t border-gray-100 px-5 py-4 flex items-center gap-3">
        <button
          ...
          className="flex-1 inline-flex items-center justify-center gap-2 rounded-xl bg-[#F59E0B] px-4 py-2.5 text-sm font-semibold text-white hover:bg-[#E64500] transition-colors disabled:opacity-50"
        >
