    ...
    <>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={() => { setForm(EMPTY_FORM); setEditingId(null); setShowCreate(true); }} className="inline-flex items-center gap-1.5 rounded-xl bg-[#FF4D00] px-4 py-2 text-xs font-semibold text-white hover:bg-[#E64500] transition-colors">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-5">
        {[
          ...
          { label: "Open", value: counts.open, color: "#FF4D00" },
        ].map((s) => (
      ...
      <div className="flex flex-col gap-2 sm:flex-row">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full rounded-xl border border-gray-200 bg-white py-2.5 pl-9 pr-4 text-sm text-gray-900 placeholder:text-gray-400 focus:border-[#FF4D00] focus:outline-none focus:ring-1 focus:ring-[#FF4D00]/30"
          />
        </div>
        <select
          value={filterSentiment}
          onChange={(e) => setFilterSentiment(e.target.value)}
          className="rounded-xl border border-gray-200 bg-white px-3 py-2.5 text-sm font-semibold text-gray-700 focus:border-[#FF4D00] focus:outline-none"
        >
                ...
                {expanded && (
                  <div className="border-t border-gray-100 px-4 py-4 space-y-3">
                    ...
                    <div className="flex items-center gap-2 pt-2 border-t border-gray-100">
                      <button onClick={() => startEdit(obs)} className="text-xs font-semibold text-[#FF4D00] hover:underline">Edit</button>
