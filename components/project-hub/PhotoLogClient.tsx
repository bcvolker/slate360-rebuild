      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="rounded-lg bg-[#3B82F6] px-4 py-2 text-sm font-semibold text-foreground transition hover:bg-[#1D4ED8]"
          >
      ...
      {loading ? (
        ...
        <div className="rounded-2xl border border-dashed border-gray-300 bg-white p-8 text-sm text-gray-500">
          ...
          <button
            ...
            className="mt-3 rounded-md bg-[#3B82F6] px-3 py-1.5 text-xs font-semibold text-foreground transition hover:bg-[#1D4ED8]"
          >
            Add Demo Photos
          </button>
        </div>
