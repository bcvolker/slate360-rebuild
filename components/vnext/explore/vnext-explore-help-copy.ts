...
export const VNEXT_EXPLORE_HELP: Record<VnextExploreRepresentation, string> = {
  reality: "Drag to orbit, scroll to zoom. This is the captured space itself — a photo-real 3D scan.",
  geometry: "Drag to orbit, scroll to zoom. This is the 3D model of the space.",
  ...
  thermal: "Use Prev/Next or the thumbnails to browse thermal images from this visit.",
};
