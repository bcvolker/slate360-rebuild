...
export default function Footer() {
  return (
    <footer className="relative z-10 w-full text-xs py-8 snap-end bg-[#F0F4F8] !bg-[#F0F4F8] border-t border-[#4F89D4]/20 shadow-[0_-12px_40px_rgba(79,137,212,0.08)] slate360-footer">
