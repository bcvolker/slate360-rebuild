...
export default function Footer() {
  return (
    <footer className="relative z-10 w-full text-xs bg-[color:var(--slate360-charcoal)] text-slate-200 border-t border-[color:var(--slate360-grey)]/40 shadow-[0_-6px_30px_rgba(0,0,0,0.7)] py-8">
