...
export default function Footer() {
  return (
    <footer className="w-full text-xs bg-zinc-900/95 backdrop-blur-md border-t border-white/10 shadow-[0_-4px_30px_rgba(0,0,0,0.5)] py-6 snap-start scroll-mt-[100vh]">
