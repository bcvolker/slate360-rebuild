...
export default function Footer() {
  return (
    <footer className="relative z-10 w-full text-xs py-8 snap-end bg-[#363434] !bg-[#363434] border-t border-[#B37031]/30 shadow-[0_-12px_40px_rgba(79,137,212,0.08)] slate360-footer">
