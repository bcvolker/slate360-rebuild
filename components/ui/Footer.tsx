...
export default function Footer() {
  return (
    <footer className="relative z-10 w-full text-xs py-8 snap-end bg-[#e5e7eb] border-t border-[#B37031]/30 shadow-[0_-12px_40px_rgba(79,137,212,0.08)] slate360-footer">
      <div className="mx-auto flex max-w-6xl items-center justify-between flex-wrap gap-4 px-6">
        <nav className="flex items-center gap-6 flex-wrap text-slate-700">
