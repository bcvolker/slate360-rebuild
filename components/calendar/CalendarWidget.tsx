...
const EVENT_COLORS = [
  "#F59E0B","#3B82F6","#10B981","#8B5CF6","#F59E0B","#EF4444","#06B6D4","#EC4899",
];
          ...
          {addingEvent && (
            <div className="mb-4 p-3.5 rounded-xl bg-gray-50 border border-gray-200 space-y-2.5">
              <input
                ...
                className="w-full px-3 py-2 rounded-lg border border-gray-200 text-xs focus:outline-none focus:ring-2 focus:ring-[#F59E0B]/20 focus:border-[#F59E0B]"
              />
              ...
              <input
                ...
                className="w-full px-3 py-2 rounded-lg border border-gray-200 text-xs focus:outline-none focus:ring-2 focus:ring-[#F59E0B]/20 focus:border-[#F59E0B] bg-white"
              />
                ...
                <div className="flex gap-2">
                  <div className="flex-1">
                    ...
                    <input
                      ...
                      className="w-full px-2 py-1.5 rounded-lg border border-gray-200 text-xs focus:outline-none focus:ring-2 focus:ring-[#F59E0B]/20 focus:border-[#F59E0B] bg-white"
                    />
                  </div>
                  <div className="flex-1">
              ...
              <textarea
                ...
                className="w-full px-3 py-2 rounded-lg border border-gray-200 text-xs focus:outline-none focus:ring-2 focus:ring-[#F59E0B]/20 focus:border-[#F59E0B] resize-none"
              />
            ...
            {selectedDayEvents.length === 0 && !addingEvent && (
              <div className="text-center py-6">
                ...
                <button
                  ...
                  className="mt-2 text-[11px] font-semibold text-[#F59E0B] hover:underline"
                >
                  + Add event
                </button>
              </div>
