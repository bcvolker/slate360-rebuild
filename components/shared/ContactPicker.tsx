...
export default function ContactPicker({
  ...
  const inputClasses =
    "w-full px-3.5 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#F59E0B]/20 focus:border-[#F59E0B] transition-all disabled:opacity-50 disabled:cursor-not-allowed";
  ...
  return (
    <div ref={wrapperRef} className={`relative ${className}`}>
      <button
        onClick={handleOpen}
        disabled={disabled}
        className="flex items-center gap-2 px-3.5 py-2 rounded-xl border border-gray-200 text-sm text-gray-600 hover:border-[#F59E0B]/50 hover:text-[#F59E0B] transition-all disabled:opacity-50"
      >
        <UserPlus size={14} />
        Pick contact
            ...
            <div className="p-3 border-b border-gray-100">
              <div className="relative">
                ...
                <input
                  ...
                  onChange={(e) => handleQueryChange(e.target.value)}
                  placeholder="Search…"
                  className="w-full pl-8 pr-3 py-2 rounded-lg border border-gray-200 text-xs focus:outline-none focus:ring-2 focus:ring-[#F59E0B]/20 focus:border-[#F59E0B]"
                />
              </div>
            </div>
            <ContactDropdown
