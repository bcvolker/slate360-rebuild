    ...
    >
      ...
      >
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm outline-none focus:border-[#F59E0B] focus:ring-1 focus:ring-[#F59E0B]/20"
                />
              </div>
              <div>
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  ...
                  <input value={form.companyCity} onChange={f("companyCity")} placeholder="Denver" className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm outline-none focus:border-[#F59E0B]" />
                </div>
                <div>
                  <label className="mb-1 block text-xs font-semibold text-gray-700">State</label>
                  <input value={form.companyState} onChange={f("companyState")} placeholder="CO" maxLength={2} className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm outline-none focus:border-[#F59E0B]" />
                </div>
                <div>
                  <label className="mb-1 block text-xs font-semibold text-gray-700">ZIP</label>
                  <input value={form.companyZip} onChange={f("companyZip")} placeholder="80202" className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm outline-none focus:border-[#F59E0B]" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input value={form.companyPhone} onChange={f("companyPhone")} placeholder="(303) 555-0100" type="tel" className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm outline-none focus:border-[#F59E0B]" />
                </div>
                <div>
                  <label className="mb-1 block text-xs font-semibold text-gray-700">
                    <Mail size={10} className="mr-1 inline" />Email
                  </label>
                  <input value={form.companyEmail} onChange={f("companyEmail")} placeholder="info@acme.com" type="email" className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm outline-none focus:border-[#F59E0B]" />
                </div>
              </div>
              <div>
                <label className="mb-1 block text-xs font-semibold text-gray-700">
                ...
                <input value={form.licenseNumber} onChange={f("licenseNumber")} placeholder="GC-12345" className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm outline-none focus:border-[#F59E0B]" />
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-gray-100 px-6 py-4">
          <button
            onClick={handleSave}
            className="w-full inline-flex items-center justify-center gap-2 rounded-lg bg-[#F59E0B] px-4 py-2.5 text-sm font-semibold text-white hover:bg-[#E64500] transition"
          >
