 ...
 *
 * For LIGHT backgrounds use `<SlateLogoOnLight />` instead.
 * Do not add a `variant` prop here — variants reintroduce the
 * "wrong logo on wrong background" bug class.
 */
...
interface SlateLogoProps extends SVGProps<SVGSVGElement> {
  size?: keyof typeof SIZE_MAP;
}

export function SlateLogo({ size = "md", className, ...svgProps }: SlateLogoProps) {
  return (
    <svg
    ...
    >
      ...
      <g>
        {/* SLATE letterforms — white on dark surfaces */}
        <path fill="#ffffff" d="M376.45,122.79h-69.23c-8.72,0-15.82-7.1-15.82-15.82V19.83h17.12v85.84h67.92v17.12Z" />
        <path fill="#ffffff" d="M249.64,122.79h-74.94v-17.12h74.94c7.79,0,11.34-6.72,11.34-12.96s-3.55-12.96-11.34-12.96c-.21,0-.42,0-.63-.02l-43.81-3.22c-16.85-.83-29.27-12.02-29.56-26.66,0-.06,0-.11,0-.17v-3.23c0-15.81,12.37-26.85,30.08-26.85h65.74v17.12h-65.74c-3.04,0-12.96.7-12.96,9.73v3.14c.17,6.38,6.82,9.53,13.35,9.83.08,0,.16,0,.24.01l43.64,3.21c16.06.18,28.12,13.05,28.12,30.08s-12.24,30.08-28.46,30.08Z" />
        <path fill="#ffffff" d="M706.13,36.71v-17.12h-80.02c-8.74,0-15.86,7.11-15.86,15.86v71.48c0,8.74,7.11,15.86,15.86,15.86h80.02v-17.12h-78.75v-25.92h72.13v-17.12h-72.13v-25.92h78.75Z" />
        ...
        <path fill="#ffffff" d="M491.5,123.05h19.29l-49.25-94.93c-2.73-5.26-8.1-8.54-14.02-8.56h-.05c-5.9,0-11.28,3.24-14.03,8.46l-50.07,95.02h19.35l14.95-28.36h59.13l14.71,28.36ZM426.68,77.56l20.78-39.42,20.45,39.42h-41.23Z" />
        <polygon fill="#ffffff" points="600.97 19.59 484.67 19.59 484.67 36.71 533.45 36.71 533.45 123.05 550.57 123.05 550.57 36.71 600.97 36.71 600.97 19.59" />
      ...
      {/* S-mark icon lower — white */}
      <path fill="#ffffff" d="M80.23,43.82l-17.16,9.69,60.64,34.72c.16.09.57.32.57.97s-.42.89-.57.97l-38.47,21.48-3.26,1.82-3.26-1.82-59.83-33.4v19.27s58.99,32.94,58.99,32.94c1.27.71,2.69,1.07,4.1,1.07s2.83-.36,4.1-1.07l55.02-30.72v-20.91l-60.88-35.01Z" />
    </svg>
  );
}
