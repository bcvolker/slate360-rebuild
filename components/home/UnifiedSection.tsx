...
export default function UnifiedSection({ id, tile, index, displayTheme = "deep", tone }: UnifiedSectionProps) {
  ...
  return (
    <section
      ...
      id={id}
      data-snap="tile"
      className={`min-h-screen w-full flex flex-col md:grid md:grid-cols-2 md:gap-10 items-center justify-center px-4 py-10 md:px-10 lg:px-20 relative overflow-hidden pt-24 md:pt-28 lg:pt-0 md:snap-start ${sectionBackground}`}
      style={sectionStyle}
    >
      {/* TEXT CONTENT CARD */}
