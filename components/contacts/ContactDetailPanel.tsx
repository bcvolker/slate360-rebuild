      ...
      >
        ...
        <div className="flex items-center gap-3 px-5 py-4 border-b border-gray-100">
          ...
          <div className="flex-1 min-w-0">
            {editing ? (
              <input
                className="w-full text-sm font-bold text-gray-900 border-b border-[#F59E0B] outline-none bg-transparent pb-0.5"
                value={form.name}
          ...
          {(["info", "files"] as const).map((t) => (
            <button
              ...
              className={`flex-1 py-2.5 text-xs font-semibold capitalize transition-colors ${
                tab === t ? "text-[#F59E0B] border-b-2 border-[#F59E0B]" : "text-gray-400 hover:text-gray-600"
              }`}
            >
        ...
        <div className="flex-1 overflow-y-auto p-5">
                ...
                <div key={key}>
                  ...
                  {editing ? (
                    <input
                      ...
                      className="w-full px-3 py-2 rounded-lg border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#F59E0B]/20 focus:border-[#F59E0B]"
                      placeholder={label}
                    />
                  ) : (
              ...
              <div>
                ...
                {editing ? (
                  <textarea
                    ...
                    className="w-full px-3 py-2 rounded-lg border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#F59E0B]/20 focus:border-[#F59E0B] resize-none"
                    placeholder="Notes…"
                  />
                ) : (
          ...
          {tab === "files" && (
            <div className="space-y-2">
              <label className="flex items-center gap-2 w-full py-2.5 px-3 rounded-xl border-2 border-dashed border-gray-200 text-xs text-gray-500 hover:border-[#F59E0B]/40 hover:text-[#F59E0B] cursor-pointer transition-colors">
