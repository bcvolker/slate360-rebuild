...
const COLORS = ["#F59E0B","#2563EB","#059669","#7C3AED","#D97706","#DB2777","#0891B2","#65A30D"];
          ...
          {(["quick", "detailed"] as const).map((m) => (
            <button
              ...
              className={`flex-1 py-2 text-xs font-semibold rounded-lg transition-all capitalize ${
                mode === m ? "bg-[#F59E0B] text-white" : "bg-gray-100 text-gray-500 hover:bg-gray-200"
        ...
        <div className="p-6 space-y-4 max-h-[60vh] overflow-y-auto">
          ...
          <div>
            ...
            <input
              ...
              onChange={set("name")}
              autoFocus
              className="w-full px-3.5 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#F59E0B]/20 focus:border-[#F59E0B] transition-all"
            />
          </div>
            ...
            <>
                      ...
                      <button
                        ...
                        className={`px-2.5 py-1 rounded-full text-[11px] font-semibold border transition-all ${
                          selectedProjects.includes(p.id)
                            ? "border-[#F59E0B] bg-[#F59E0B]/8 text-[#F59E0B]"
              ...
              <div>
                ...
                <textarea
                  ...
                  value={form.notes}
                  onChange={set("notes")}
                  className="w-full px-3.5 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#F59E0B]/20 focus:border-[#F59E0B] resize-none transition-all"
                />
              </div>
            </>
          )}
