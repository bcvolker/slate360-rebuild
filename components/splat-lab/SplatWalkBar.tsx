    ...
    <div
      className={
        placement === "stack"
          ...
          : "pointer-events-none absolute inset-x-0 bottom-0 z-20 flex justify-center px-3 pl-[max(3.5rem,env(safe-area-inset-left))] pr-[max(0.75rem,env(safe-area-inset-right))] sm:px-4"
      }
      style={
        placement === "stack"
          ? undefined
