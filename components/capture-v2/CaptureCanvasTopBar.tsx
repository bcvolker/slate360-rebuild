...
export function CaptureCanvasTopBar({
  ...
  return (
    ...
    >
      <div
        className="flex h-11 items-center gap-2 border border-[var(--accent-border-green)] bg-[color-mix(in_srgb,var(--graphite-canvas)_72%,transparent)] px-3 backdrop-blur-md"
