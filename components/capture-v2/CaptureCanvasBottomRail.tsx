...
export function CaptureCanvasBottomRail({
  ...
  return (
    ...
    >
      <p className="mb-3 text-center text-[10px] font-semibold tracking-wide text-[var(--graphite-muted)]">
      ...
      <div className="flex items-end justify-center">
        <button
          ...
          className="relative flex h-[4.25rem] w-[4.25rem] -translate-y-6 items-center justify-center rounded-full border-[3px] border-[color-mix(in_srgb,var(--graphite-primary)_55%,transparent)] bg-[var(--graphite-primary)] shadow-[var(--mobile-app-card-glow-primary)] transition active:scale-95 disabled:opacity-50"
