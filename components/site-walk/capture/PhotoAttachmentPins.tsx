      ...
      {draftPin && (
        <div className="absolute inset-x-3 bottom-3 z-30 rounded-[1.5rem] border border-white/15 bg-zinc-950/88 p-3 text-white shadow-2xl backdrop-blur-xl">
          <div className="flex items-start justify-between gap-3">
            <div>
              <p className="text-[11px] font-black uppercase tracking-[0.16em] text-amber-200">Pin files to photo</p>
          ...
          <div className="mt-3 flex flex-wrap items-center gap-2">
            ...
            <button type="button" onClick={() => fileInputRef.current?.click()} disabled={uploading || files.length >= PHOTO_ATTACHMENT_MAX_FILES} className="inline-flex min-h-10 items-center gap-2 rounded-2xl bg-emerald-400 px-3 text-sm font-black text-zinc-950 disabled:opacity-50">
