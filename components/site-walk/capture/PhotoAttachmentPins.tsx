            ...
            <div className="fixed inset-0 z-[3000] flex items-center justify-center bg-black/25 p-4">
              <div className="max-h-[78dvh] w-full max-w-md overflow-y-auto rounded-[1.5rem] border border-white/15 bg-zinc-950/94 p-3 text-white shadow-2xl backdrop-blur-xl no-scrollbar">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    <p className="text-[11px] font-black uppercase tracking-[0.16em] text-[var(--graphite-primary)]">
                      Pin files to photo
                    </p>
                    <p className="mt-1 text-xs font-semibold text-white/70">
                      Add up to {PHOTO_ATTACHMENT_MAX_FILES} files, max 25MB each.
                    </p>
                  </div>
                  <button
                    type="button"
                ...
                <div className="mt-3 grid gap-2 sm:grid-cols-2">
                  <input
                    ...
                    className="rounded-2xl border border-white/15 bg-white/10 px-3 py-2 text-sm font-bold outline-none placeholder:text-white/40"
                    placeholder="Proposal, submittal, quote…"
                  />
                  <input
                    value={note}
                ...
                <div className="mt-3 flex flex-wrap items-center gap-2">
                  ...
                  <button
                    ...
                    disabled={uploading || files.length >= PHOTO_ATTACHMENT_MAX_FILES}
                    className="inline-flex min-h-10 items-center gap-2 rounded-2xl bg-[var(--graphite-primary)] px-3 text-sm font-black text-[var(--graphite-canvas)] disabled:opacity-50"
                  >
                  ...
                  <button
                    ...
                    className="min-h-10 rounded-2xl bg-white px-4 text-sm font-black text-zinc-950 disabled:opacity-50"
                  >
                    Save pin
                  </button>
              ...
              <div className="max-h-[78dvh] w-full max-w-md overflow-y-auto rounded-[1.5rem] border border-cyan-300/20 bg-slate-950/95 p-3 text-white shadow-2xl backdrop-blur-xl no-scrollbar">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-1 text-xs font-semibold text-white/60">
                      Update the marker name or field note.
                    </p>
                  </div>
                  <button
                    type="button"
                ...
                <div className="mt-3 flex gap-2">
                  <button
                    ...
                    className="min-h-10 rounded-2xl bg-cyan-300 px-4 text-sm font-black text-slate-950"
                  >
                    Save changes
                  </button>
                  <button
                    type="button"
                    onClick={() => editingPinId && removePin(editingPinId)}
                    className="min-h-10 rounded-2xl border border-rose-300/30 bg-rose-500/10 px-4 text-sm font-black text-rose-100"
                  >
                    Remove pin
                  </button>
                </div>
