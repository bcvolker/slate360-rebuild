...
export default function MediaViewer({ hero = false, placeholder = "Interactive Content Coming Soon", style }: Props) {
  ...
  return (
    <div
      className={`relative flex items-center justify-center ${widthClass} ${heightClass} min-w-[320px] border-2 border-dashed rounded-2xl ${dragOver ? "border-[var(--brand-blue)] bg-slate-50" : "border-slate-300 bg-white"} shadow-md`}
      style={style}
