...
type SlateDropContextMenuProps = {
  ...
  onDuplicateFile: (target: ContextMenuFileTarget) => void;
      ...
      {contextMenu.target.type === "file" && (() => {
        ...
        return (
          <>
            ...
            <CtxItem icon={Files} label="Duplicate" onClick={() => {
              onDuplicateFile(target);
              onClose();
            }} />
            ...
            <CtxDivider />
            <CtxItem icon={Link2} label="Copy link" onClick={() => {
              onCopyShareLink(target);
              onClose();
            }} />
            <CtxItem
              icon={Send}
