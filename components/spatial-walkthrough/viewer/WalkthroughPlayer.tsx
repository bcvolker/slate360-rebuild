...
export function WalkthroughPlayer({
  ...
  useEffect(() => {
    ...
    try {
      ...
      defaultYaw: restrictView ? "12deg" : "0deg",
      defaultPitch: restrictView ? "26deg" : "0deg",
      navbar: false,
      mousewheel: true,
      mousemove: true,
      ...
      moveSpeed: 1.5,
      zoomSpeed: 1.4,
      defaultZoomLvl: restrictView ? 78 : 50,
      minFov: 36,
      maxFov: restrictView ? 42 : 100,
      ...
      plugins: [
        ...
        VisibleRangePlugin.withConfig({
          horizontalRange: restrictView ? ["-70deg", "110deg"] : undefined,
          verticalRange: restrictView ? ["22deg", "72deg"] : undefined,
        }),
      ],
    });
    } catch (err) {
