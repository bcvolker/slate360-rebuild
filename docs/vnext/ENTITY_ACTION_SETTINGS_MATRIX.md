...
| Write | `PUT /api/vnext/projects/[projectId]/scope` calls `replace_project_client_scope` as service role after `canAccessOperationsConsole`. Unknown ids dropped. No prices |
