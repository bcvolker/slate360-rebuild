...
| F — Operator Twin Studio tab | F1, F2, F3, F4, F5 | 1/5 | 🟨 F1 shipped: /twin-studio shell (StudioWorkspaceShell, matches Thermal V2 pattern), nav entry, Produce tab (versions + trainProfile-aware reprocess dispatch + realtime job status). Clean/Plan/Deliver are honest placeholders naming F2/F3/F4 |
