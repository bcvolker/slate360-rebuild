...
15. **Home layout contract (2026-05-15):** Primary actions enlarged to min-h-[82px] with size-6 icons and text-[13px]. Core tools enlarged to h-14 with size-5 icons and text-[13px]. Work panel anchored near bottom via mt-auto, h-[34dvh] min-h-[245px] max-h-[320px] (~3.5 rows). mb-3 gap to bottom nav. Tabs lightened (h-7, border-b-1, no "Work" label). Bottom gradient fade retained.
