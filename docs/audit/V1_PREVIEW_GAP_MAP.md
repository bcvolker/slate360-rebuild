...
15. **Home rebalance (2026-05-15):** Work panel height reduced from flex-1 to `h-[36dvh] max-h-[340px]` (~3–3.5 rows). "SITE WALK" label moved below header as standalone amber label. "Site Walk" removed from header branding area (logo only). Primary action cards min-h-[64px]. Bottom gradient fade added inside work panel for scroll affordance. mb-4 below panel for bottom nav breathing room.
