...
15. **Home layout contract (2026-05-15):** Fixed three-zone mobile layout. mt-auto removed (caused dead blank band). Command zone: pt-5 pb-4 with label text-[13px] amber-400, primary actions min-h-[92px] with size-7 icons and text-[14px], core tools h-16 with size-[22px] icons. Work panel: min-h-[285px] max-h-[335px] flex-1 with h-9 underline tabs (text-[12px]), border-b-2 amber active, bottom fade. mb-3 gap to nav. No auto-spacer. No dead blank areas.
