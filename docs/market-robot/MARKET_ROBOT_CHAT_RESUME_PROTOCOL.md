...
## Files To Read First
1. [SLATE360_PROJECT_MEMORY.md](/workspaces/slate360-rebuild/SLATE360_PROJECT_MEMORY.md)
2. [docs/market-robot/MARKET_ROBOT_BUILD_FILE.md](/workspaces/slate360-rebuild/docs/market-robot/MARKET_ROBOT_BUILD_FILE.md)
3. [docs/market-robot/MARKET_ROBOT_PROMPT_BACKLOG.md](/workspaces/slate360-rebuild/docs/market-robot/MARKET_ROBOT_PROMPT_BACKLOG.md)
4. Only then, the batch-specific implementation files named in the active prompt.

## Current Batch
- Current batch is Batch 0.
- Batch 0 is analysis plus build-file setup only.
- No rescue implementation has been authorized yet.
...
- Update [docs/market-robot/MARKET_ROBOT_BUILD_FILE.md](/workspaces/slate360-rebuild/docs/market-robot/MARKET_ROBOT_BUILD_FILE.md) with new findings or changed constraints.
- Update [docs/market-robot/MARKET_ROBOT_PROMPT_BACKLOG.md](/workspaces/slate360-rebuild/docs/market-robot/MARKET_ROBOT_PROMPT_BACKLOG.md) if the batch order, risks, or success criteria changed.
- Overwrite the Latest Session Handoff section in [SLATE360_PROJECT_MEMORY.md](/workspaces/slate360-rebuild/SLATE360_PROJECT_MEMORY.md) before ending the chat.
...
- Re-check [docs/market-robot/MARKET_ROBOT_ENV_AND_TOOL_MATRIX.md](/workspaces/slate360-rebuild/docs/market-robot/MARKET_ROBOT_ENV_AND_TOOL_MATRIX.md) if the batch depends on live mode, scheduler secrets, or external tooling.
- Re-check [slate360-context/ONGOING_ISSUES.md](/workspaces/slate360-rebuild/slate360-context/ONGOING_ISSUES.md) and [ops/bug-registry.json](/workspaces/slate360-rebuild/ops/bug-registry.json) before product edits.
...
- Treat [docs/market-robot/MARKET_ROBOT_BUILD_FILE.md](/workspaces/slate360-rebuild/docs/market-robot/MARKET_ROBOT_BUILD_FILE.md) as the canonical current-state file unless a code read proves it stale.