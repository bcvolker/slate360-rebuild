-- Spatial project items, locators, comments, activity, and reusable project documents.
-- Additive. Lightweight spatial_pins remain valid without a project_item_id.

ALTER TABLE public.spatial_audio_assets DROP CONSTRAINT IF EXISTS spatial_audio_assets_kind_check;
ALTER TABLE public.spatial_audio_assets ADD CONSTRAINT spatial_audio_assets_kind_check
  CHECK (kind IN ('narration','voice_note','item_comment'));
