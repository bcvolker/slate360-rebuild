    ...
    <div className="fixed inset-0 z-50 flex flex-col bg-black/90" onClick={onClose}>
      <div className="flex items-center justify-between bg-black/60 px-4 py-3" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className="rounded-md p-1.5 text-gray-400 hover:bg-white/10 hover:text-white" title="Download">
            <Download size={16} />
          </button>
      ...
      <div className="flex flex-1 items-center justify-center p-4" onClick={(e) => e.stopPropagation()}>
        ...
        {url ? (
          ...
          <div className="flex h-64 w-64 items-center justify-center rounded-lg bg-zinc-800 text-zinc-500">
            <FileImage size={48} />
          </div>
        )}
        <button onClick={onNext} disabled={index === files.length - 1}
