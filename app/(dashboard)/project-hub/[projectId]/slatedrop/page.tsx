    ...
    <div className="flex flex-col" style={{ height: "calc(100svh - 3.5rem)" }}>
      ...
      <div className="shrink-0 flex items-center gap-3 px-4 sm:px-6 py-3 bg-white border-b border-gray-100">
        <Link
          ...
          className="flex items-center gap-1.5 text-xs font-semibold text-gray-500 hover:text-[#FF4D00] transition-colors"
        >
          <ChevronLeft size={14} /> {projectName}
        </Link>
        <span className="text-gray-300">/</span>
        <span className="flex items-center gap-1.5 text-xs font-semibold text-[#FF4D00]">
