          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input value={reportTitle} onChange={(e) => setReportTitle(e.target.value)} placeholder={`${projectName ? projectName + " — " : ""}${reportType} Report`} className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm outline-none focus:border-[#FF4D00]" />
              </div>
              <div>
