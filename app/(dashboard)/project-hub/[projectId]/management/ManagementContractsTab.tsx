        ...
        <div className="sticky top-24 rounded-2xl border border-gray-100 bg-white shadow-sm overflow-hidden">
          ...
          {!showCForm ? (
            <div className="p-5 flex flex-col items-center gap-3 text-center">
              ...
              <button onClick={() => { setCForm({ ...EMPTY_C_FORM }); setEditingCId(null); setShowCForm(true); }}
                className="w-full inline-flex items-center justify-center gap-1.5 rounded-lg bg-[#F59E0B] px-4 py-2.5 text-sm font-semibold text-white hover:bg-[#E64500] transition">
            ...
            <div className="p-5 space-y-4 max-h-[70vh] overflow-y-auto">
              <div>
                ...
                <input value={cForm.title} onChange={(e) => setCForm({ ...cForm, title: e.target.value })} placeholder="e.g. Prime Contract – Phase 1" className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm outline-none focus:border-[#F59E0B] focus:ring-1 focus:ring-[#F59E0B]/20" />
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="mb-1 block text-xs font-bold text-gray-700">Contract Type</label>
                  <select value={cForm.contract_type} onChange={(e) => setCForm({ ...cForm, contract_type: e.target.value })} className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm outline-none focus:border-[#F59E0B]">
                ...
                <div>
                  ...
                  <select value={cForm.status} onChange={(e) => setCForm({ ...cForm, status: e.target.value })} className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm outline-none focus:border-[#F59E0B]">
              ...
              <div>
                ...
                <input value={cForm.parties} onChange={(e) => setCForm({ ...cForm, parties: e.target.value })} placeholder="Owner, GC – separate by comma" className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm outline-none focus:border-[#F59E0B]" />
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="mb-1 block text-xs font-bold text-gray-700">Contract Value ($)</label>
                  <input type="number" value={cForm.contract_value} onChange={(e) => setCForm({ ...cForm, contract_value: e.target.value })} placeholder="0" min="0" className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm outline-none focus:border-[#F59E0B]" />
                </div>
                <div>
                  <label className="mb-1 block text-xs font-bold text-gray-700">Executed Date</label>
                  <input type="date" value={cForm.executed_date} onChange={(e) => setCForm({ ...cForm, executed_date: e.target.value })} className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm outline-none focus:border-[#F59E0B]" />
                </div>
              </div>
              {!editingCId && (
                <div>
              ...
              <div>
                ...
                <textarea value={cForm.notes} onChange={(e) => setCForm({ ...cForm, notes: e.target.value })} rows={2} placeholder="Scope notes, amendments…" className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm outline-none focus:border-[#F59E0B] resize-none" />
              </div>
