  ...
  return (
    <VnextOwnerShell pathname="/vnext/ops/qa">
      <div className="w-full px-[var(--vnext-pad-x)] py-[var(--vnext-pad-y)]">
        ...
        <VnextReleaseActions projectId="drawings" projectName="Drawings" representation="plans" representationLabel="Plans" sourceId="sheet-1" version="A1.0" published={false} />
