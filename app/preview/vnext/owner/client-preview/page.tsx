...
export default function PreviewClientViewPage() {
  const data = {
  ...
  return (
    <VnextClientShell pathname={PREVIEW_OVERVIEW_NAV_PATH}>
      <VnextClientPreviewFrame exitHref="/preview/vnext/owner/projects/harbor" candidate={null}>
        ...
        <VnextExploreShell data={data} initialPresent={false} basePath="/preview/vnext/owner/client-preview" item={null} canWrite={false} views={[]} persistViews="local" />
