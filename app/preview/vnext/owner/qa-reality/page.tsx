  ...
  return (
    <VnextOwnerShell pathname="/vnext/ops/qa">
      <div className="w-full px-[var(--vnext-pad-x)] py-[var(--vnext-pad-y)]">
        ...
        <VnextReleaseActions projectId="harbor" projectName="Harbor Street" representation="reality" representationLabel="Reality" sourceId="model-b" version="Sep 22, 2026" published={false} />
