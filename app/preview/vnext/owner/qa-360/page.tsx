  ...
  return (
    <VnextOwnerShell pathname="/vnext/ops/qa">
      <div className="w-full px-[var(--vnext-pad-x)] py-[var(--vnext-pad-y)]">
        ...
        <VnextReleaseActions projectId="library" projectName="Library" representation="pano360" representationLabel="360" sourceId="pano-1" version="East stair" published={false} />
