...
import { HISTORY_LOAD_ERROR } from "@/lib/vnext/history/history-types";
...
export default function PreviewVnextHistoryErrorPage() {
  return (
    <VnextClientShell pathname={PREVIEW_OVERVIEW_NAV_PATH}>
      ...
      <VnextHistoryBrowser visits={[]} historyBase={PREVIEW_HISTORY_BASE} error={HISTORY_LOAD_ERROR} />
    </VnextClientShell>
  );
}
