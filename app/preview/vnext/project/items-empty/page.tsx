...
import { PREVIEW_EXPLORE_BASE, PREVIEW_ITEMS_BASE } from "@/lib/vnext/preview-items-fixtures";
import {
...
export default function PreviewVnextItemsEmptyPage() {
  return (
    <VnextClientShell pathname={PREVIEW_OVERVIEW_NAV_PATH}>
      ...
      />
      <VnextItemsBrowser items={[]} itemsBase={PREVIEW_ITEMS_BASE} exploreBase={PREVIEW_EXPLORE_BASE} />
    </VnextClientShell>
  );
}
