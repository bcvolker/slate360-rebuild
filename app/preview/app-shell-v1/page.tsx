              ...
              return (
                <div
                  ...
                  className={`relative rounded-2xl border p-4 transition-all duration-150 ${
                    isLive
                      ? "bg-[#151A23] border-cobalt/30 hover:border-cobalt hover:bg-cobalt/[0.06] hover:shadow-[0_0_24px_-4px_rgba(245,158,11,0.45)] cursor-pointer"
          ...
          <div className="grid grid-cols-2 gap-3">
            {quickActions.map((qa, i) => {
              ...
              return (
                <button
                  key={qa.label}
                  className={`flex items-center gap-3 rounded-2xl bg-[#151A23] border border-white/5 px-4 py-3 transition-all duration-150 hover:border-cobalt hover:bg-cobalt/[0.06] hover:shadow-[0_0_20px_-4px_rgba(245,158,11,0.4)] text-left ${
                    lastOdd ? "col-span-2 max-w-[calc(50%-0.375rem)] mx-auto w-full" : ""
                  }`}
                >
