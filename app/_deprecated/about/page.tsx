    ...
    <div className="bg-white min-h-screen text-gray-900 antialiased">
      ...
      <section className="pt-32 pb-16 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center">
          <span className="inline-block text-xs font-semibold uppercase tracking-widest px-3 py-1.5 rounded-full mb-6" style={{ backgroundColor: "#FF4D001A", color: "#FF4D00" }}>Our story</span>
          <h1 className="text-5xl sm:text-6xl font-black tracking-tight mb-6" style={{ color: "#FF4D00" }}>About Slate360</h1>
      ...
      <section className="py-20 px-4 sm:px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-black mb-10" style={{ color: "#FF4D00" }}>What we stand for</h2>
      ...
      <section className="py-20 px-4 sm:px-6 text-white text-center" style={{ backgroundColor: "#18181b" }}>
