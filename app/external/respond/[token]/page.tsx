      ...
      <main className="min-h-screen bg-gradient-to-b from-slate-50 to-white p-4 flex items-center justify-center">
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="rounded-xl border border-slate-200 bg-white px-5 py-3 text-sm text-slate-600 flex items-center gap-2 shadow-sm">
            <Loader2 size={16} className="animate-spin text-[#F59E0B]" /> Loading response form…
          </div>
        </div>
      </main>
    );
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-50 to-white p-4 sm:p-6">
      ...
      <section className="mx-auto max-w-2xl overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        {/* Branded header bar */}
        <div className="bg-gradient-to-r from-[#F59E0B] to-[#162D69] px-6 py-5 text-white">
        ...
        <form onSubmit={submit} className="space-y-4">
          <div>
            ...
            <select
              ...
              className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm text-slate-900 focus:border-[#F59E0B] focus:ring-2 focus:ring-[#F59E0B]/20 focus:outline-none transition-all"
            >
          ...
          <div>
            ...
            <textarea
              ...
              rows={5}
              required
              className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 focus:border-[#F59E0B] focus:ring-2 focus:ring-[#F59E0B]/20 focus:outline-none transition-all resize-none"
          ...
          <div>
            ...
            <label className="flex cursor-pointer items-center justify-center gap-2 rounded-xl border border-dashed border-slate-300 bg-slate-50/60 px-4 py-3.5 text-sm text-slate-500 hover:bg-slate-100 hover:border-[#F59E0B]/40 transition-all">
              <UploadCloud size={16} className={file ? "text-[#F59E0B]" : ""} />
          ...
          <div className="pt-1">
            <button
              type="submit"
              disabled={submitting}
              className="w-full flex items-center justify-center gap-2 rounded-xl bg-[#F59E0B] px-5 py-3 text-sm font-bold text-white hover:bg-[#E64500] disabled:opacity-60 transition-all active:scale-[0.98]"
            >
