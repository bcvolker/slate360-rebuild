  ...
  return (
    <div className="dark min-h-screen bg-zinc-950 flex flex-col">
      ...
      <div className="flex items-center justify-between px-6 py-4 bg-zinc-950/90 backdrop-blur-md border-b border-zinc-800">
        ...
        <Link href="/signup" className="text-sm text-zinc-400 hover:text-[#D4AF37] transition-colors">
          No account? <span className="font-semibold text-[#D4AF37]">Sign up free</span>
        </Link>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md bg-zinc-900/60 rounded-2xl border border-zinc-800 backdrop-blur-sm shadow-xl p-8">
          <div className="mb-8">
            ...
            <p className="text-sm text-zinc-400">Sign in to your Slate360 account</p>
          </div>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center"><span className="bg-zinc-900 px-3 text-xs text-zinc-500">or sign in with email</span></div>
          </div>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div>
              ...
              <div className="text-right mt-1.5">
                <Link href="/forgot-password" className="text-xs text-zinc-500 hover:text-[#D4AF37] transition-colors">Forgot password?</Link>
              </div>
            </div>
            <button
              type="submit" disabled={loading || !!oauthLoading}
              className="w-full flex items-center justify-center gap-2 py-3.5 rounded-full font-semibold text-sm text-black bg-[#D4AF37] hover:bg-[#c49f30] transition-all hover:scale-[1.02] disabled:opacity-50 disabled:scale-100 shadow-[0_0_20px_rgba(212,175,55,0.3)]"
            >
          ...
          <p className="text-center text-xs text-zinc-500 mt-6">
            No account?{" "}
            <Link href="/signup" className="font-semibold text-[#D4AF37] hover:underline">Start a free trial</Link>
          </p>
        </div>
      </div>
    </div>
