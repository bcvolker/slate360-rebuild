...
const highlights = [
  "Finder-style file browser — familiar, intuitive, instant",
  "Right-click any file for Secure Send — no extra steps",
  "Share files with external stakeholders via secure token link",
  "Auto-folder creation when a new project is created",
  "Everything saves to the correct project sub-folder automatically",
  "Drag-and-drop upload with progress tracking and retry logic",
  "Upload audit log — who sent what, when, and to whom",
  "Trigger PDF-to-submittal auto-task on drop into Submittals folder",
];

const gallery = [
  { id: 1, label: "File Browser", bg: "from-orange-950/60 to-zinc-950", desc: "Finder-style navigation across all your projects" },
  { id: 2, label: "Secure Send", bg: "from-red-950/60 to-zinc-950", desc: "Right-click any file to generate a secure share link" },
  { id: 3, label: "Upload Dropzone", bg: "from-amber-950/60 to-zinc-950", desc: "Drag files in. They land in exactly the right folder." },
  { id: 4, label: "Audit Trail", bg: "from-zinc-800/60 to-zinc-950", desc: "Full log of every upload, send, and download" },
];
    ...
    <div className="bg-black min-h-screen text-white antialiased">
      ...
      <section className="pt-36 pb-16 px-6 md:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-black tracking-tight leading-none mb-6">SlateDrop</h1>
          <p className="text-xl text-white/55 leading-relaxed max-w-2xl mb-8">
            The fastest way to get files where they need to go. Drag, right-click, and send — 
            with full audit trails, auto-folders, and external share links built in.
          </p>
      ...
      <section className="py-20 px-6 md:px-8 bg-zinc-950/50 text-center">
        <div className="max-w-xl mx-auto">
          <h2 className="text-3xl font-bold mb-4">Send smarter. Not harder.</h2>
      ...
      {expanded && (
        <div className="fixed inset-0 z-[200] bg-black/95 flex flex-col">
          <div className="flex items-center justify-between px-5 py-3 border-b border-white/10 flex-shrink-0">
            <span className="text-sm font-semibold text-white/80">SlateDrop — {current.label}</span>
