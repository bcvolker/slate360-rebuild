...
const highlights = [
  "Share links with scoped permissions — upload, download, or view-only per file or folder",
  "Comment threads on models, plans, photos, and 360 tours with @mentions and notifications",
  "Real-time co-editing in Design Studio for multi-user model and plan review sessions",
  "Role-based access control — Owner, Admin, Editor, Viewer at project and org levels",
  "Time-limited share links for clients and external reviewers — auto-expire for security",
  "Organization-level seat management and audit logs for Enterprise teams",
  "Unified SlateDrop file system means every collaborator sees the same folder structure",
  "Works across all modules — Project Hub RFIs, Design Studio markup, Content Studio clips",
];
      ...
      <section className="pt-32 pb-16 px-4 sm:px-6 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-500 leading-relaxed max-w-2xl mb-8">
            Share links, comment threads, real-time co-editing, and
            permission-based access for every stakeholder on the project.
          </p>
          <Link
            href="/signup"
      ...
      <section className="py-16 px-4 sm:px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <p className="text-lg text-gray-600 leading-relaxed">
            Every Slate360 module is built for teams. Share any file with a
            scoped link, leave comments directly on 3D models or 2D plans, and
            co-edit in real time inside Design Studio. Role-based permissions
            keep sensitive data locked down while giving clients and external
            reviewers exactly the access they need — nothing more, nothing less.
          </p>
        </div>
      </section>
