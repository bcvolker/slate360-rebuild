      ...
      {show3D && (
        <div className="fixed inset-0 z-[200] bg-black flex flex-col">
          ...
          <div className="flex-1 relative min-h-0">
            {/* @ts-expect-error */}
            <model-viewer src="/uploads/csbglbmodel-optimized.glb" alt="GPU-processed 3D model" auto-rotate camera-controls environment-image="neutral" exposure="0.9" style={{ width: "100%", height: "100%", background: "#0a0a0a" }} />
          </div>
