...
export function SiteWalkSetupClient({ brandSettings, projects, contacts, initialReportDefaults, tier, orgName }: Props) {
  ...
  return (
    <div className="space-y-5">
      ...
      <section className="rounded-3xl border border-slate-700/60 bg-slate-900/60 backdrop-blur-md p-6">
    ...
    <section className="rounded-3xl border border-slate-700/60 bg-slate-900/60 backdrop-blur-md p-5">
      ...
      <div className="mt-5 grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
        {controls.map((control) => (
          <div key={control} className="rounded-2xl border border-slate-700/60 bg-slate-800/60 p-4 text-sm font-black text-slate-50">
