      ...
      <div className="mx-auto max-w-5xl space-y-5">
        <section className="rounded-3xl border border-slate-300 bg-white p-6 shadow-sm">
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-700">
            This Act 2 route will list active, draft, and recently completed sessions. Prompt 5 wires real session creation and resume behavior.
          </p>
        </section>
        ...
        <section className="rounded-2xl border border-dashed border-slate-300 bg-white p-8 text-center shadow-sm">
          ...
          <p className="mx-auto mt-1 max-w-xl text-sm leading-6 text-slate-600">
            The route is live and ready for real data. Start with the capture shell while session APIs are reconciled in Prompt 0 and wired in Prompt 5.
          </p>
