...
export const SITE_WALK_PRICING: MarketingPricingTier[] = [
  {
    ...
    features: [
      "Create projects — keep plans, files, and walks organized",
      "Capture photos, voice notes, pins, and markups",
      "Quick Walks — start capturing now, attach to a project later",
      "Interactive reports clients open from a link",
      "Works offline — syncs when you're back in coverage",
    ],
...
export const BUNDLE_PRICING: MarketingPricingTier = {
  ...
  features: [
    ...
    "Add 3D twins to your projects — a running record as work progresses",
