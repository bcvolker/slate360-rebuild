export const VNEXT_CLIENT_NOTE =
  "This screen is for reviewing the client application frame. Project records are not part of this slice.";

export const VNEXT_OWNER_NOTE =
  "This screen is for reviewing the owner application frame. Queues and project operations are not part of this slice.";
...
export const VNEXT_PORTFOLIO_EMPTY =
  "There are no projects available to this account.";

export const VNEXT_PORTFOLIO_ERROR =
