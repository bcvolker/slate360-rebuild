...
Progress update (Mar 4 2026): extracted `SlateDropContextMenu.tsx`, `SlateDropActionModals.tsx`, `SlateDropSharePreviewModals.tsx`, `SlateDropFileArea.tsx`, `SlateDropSidebar.tsx`, and `SlateDropTopBar.tsx`, plus `useSlateDropFiles` and `useSlateDropUiState`; remaining work is final shell reduction.
