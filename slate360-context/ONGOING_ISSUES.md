...
Progress update (Mar 4 2026): extracted `SlateDropContextMenu.tsx`, `SlateDropActionModals.tsx`, `SlateDropSharePreviewModals.tsx`, and `SlateDropFileArea.tsx`, plus `useSlateDropFiles` and `useSlateDropUiState`; remaining work is sidebar/final shell reduction.
