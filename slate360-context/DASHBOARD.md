...
| DashboardClient | `components/dashboard/DashboardClient.tsx` | ~2,350 | ⚠️ Needs decomposition (header extracted; runtime data + floating window + widget prefs moved to hooks/components) |
